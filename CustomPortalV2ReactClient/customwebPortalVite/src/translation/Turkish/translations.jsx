...
export const TRANSLATIONS_TR = {
    ...
    AiChatTitle: "AI Sohbet",
    AiChatDescription: "Dokuman, iş akışı veya formlar hakkında sorularınızı yazabilirsiniz.",
    AiChatWelcomeMessage: "Merhaba, size nasıl yardımcı olabilirim?",
    AiChatInputPlaceholder: "Sorunuzu yazın...",
    AiChatSend: "Gönder",
    AiChatUserLabel: "Siz",
