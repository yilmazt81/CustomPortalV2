...
import {
    GetAutoComlateField,
    GetAutoComlateFieldMaps,
    GetReflectionFields,
    GetFormDefinationField,
    DeleteAutoComplateFieldMap
} from '../../lib/formdef.jsx';
import { CreateDefinationTypes } from '../../lib/companyAdressDef.jsx';
                ...
                <CRow>
                    ...
                    <CCol sm={3}>
                        ...
                        <CFormSelect id='selectDefinationType' name='complateObject' onChange={e => handleChange(e)} >
                            ...
                            <option value='FoodPerson'>{t("FoodPerson")}</option>
                        </CFormSelect>
                    </CCol>
                    {ShowFilterRow()}
                    <CCol sm={3}>
