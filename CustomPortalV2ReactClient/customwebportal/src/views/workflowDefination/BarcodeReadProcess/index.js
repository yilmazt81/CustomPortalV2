...
import BarcodeRead from 'src/content/image/barcodeRead.png';

import {
    FaCog, FaMinus
} from "react-icons/fa";
const handleStyle = { left: 30 };
function BarcodeProcessNode({ data, isConnectable }) {
        ...
        <div>
            ...
            <div>
                ...
                <CCard style={{ width: '5rem', height: "8rem" }}>
                    <CCardImage orientation="top" src={BarcodeRead} />
                    <CCardBody>
...
export default BarcodeProcessNode;
